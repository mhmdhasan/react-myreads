...
function Read() {
    const { get_books_loading: loading, get_books_error: error, books, read, updateBooks } = useAppContext();
    const matchedBooks = books.filter((book) => read.includes(book.id));
    ...
    return (
        <section className='p-3'>
            <h2 className='h3 heading'>
                ...
                <span>
                    Read books <span className='badge'>{matchedBooks.length} Books</span>
                </span>
            </h2>
